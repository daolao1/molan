...
- 若需要写作或修改正文:先完成调研——read_content 读正文与高亮;浏览【已有设定】,与本段相关的"文风""写作要求""背景故事""世界观""主线"等条目逐个 get_entry_detail 读全文,文风与写作要求必须严格遵守,背景与世界观不得矛盾;出场人物逐个 get_entry_detail(性格、说话方式、称呼表、关系);检查伏笔;涉及其他章节用 get_event_content 核对原文,禁止凭记忆编造
